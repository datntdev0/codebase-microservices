...
@Component({
  selector: 'app-sidebar-main-menu',
  templateUrl: 'sidebar-main-menu.component.html',
  standalone: false
})
export class SidebarMainMenuComponent extends AppComponentBase implements OnInit {
  menuItems: MenuItem[];
  ...
  constructor(injector: Injector, private router: Router, protected layoutStore: LayoutStoreService) {
    super(injector);
  }
