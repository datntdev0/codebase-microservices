...
public class UserToken : Entity<long>, IMayHaveTenant
{
    ...
    public UserToken(AbpUserBase user, [NotNull] string loginProvider, [NotNull] string name, string value, DateTime? expireDate = null)
    {
    ...
    public UserToken(UserIdentifier user, [NotNull] string loginProvider, [NotNull] string name, string value, DateTime? expireDate = null)
    {
        Check.NotNull(loginProvider, nameof(loginProvider));
        Check.NotNull(name, nameof(name));
