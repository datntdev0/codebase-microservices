...
using datntdev.Abp.Web.Http;

namespace datntdev.Abp.Web.Localization
{
    public class LocalizationScriptManager : ILocalizationScriptManager, ISingletonDependency
    {
