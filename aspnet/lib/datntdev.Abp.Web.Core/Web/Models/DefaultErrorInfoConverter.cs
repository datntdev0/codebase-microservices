...
namespace datntdev.Abp.Web.Models
{
    ...
    public class DefaultErrorInfoConverter : IExceptionToErrorInfoConverter
    {
        ...
        private ErrorInfo CreateErrorInfoWithoutCode(Exception exception)
        {
            ...
            if (exception is datntdev.Abp.Authorization.AbpAuthorizationException)
            {
                var authorizationException = exception as datntdev.Abp.Authorization.AbpAuthorizationException;
