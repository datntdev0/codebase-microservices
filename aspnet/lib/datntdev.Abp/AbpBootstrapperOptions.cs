...
namespace datntdev.Abp
{
    public class AbpBootstrapperOptions
    {
        ...
        /// <summary>
        /// IIocManager that is used to bootstrap the ABP system. If set to null, uses global <see cref="datntdev.Abp.Dependency.IocManager.Instance"/>
        /// </summary>
        ...
        {
            IocManager = datntdev.Abp.Dependency.IocManager.Instance;
